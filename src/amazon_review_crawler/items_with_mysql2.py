from mysql2_developed import MySqlClient
import pandas as pd
from sqlalchemy import MetaData, Column, String,Float, Table, Text, JSON, INTEGER, BOOLEAN


metadata = MetaData()
items_table = Table("items", metadata, autoload_with=my_sql_client.engine_master)
reviews_table = Table("reviews", metadata, autoload_with=my_sql_client.engine_master)

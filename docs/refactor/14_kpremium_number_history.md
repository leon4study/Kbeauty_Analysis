...
**수집 단계**:
- **1차 (2025-01-21)**: 키워드 검색 4 개 (`kbeauty / korean / wonyoung / korea`) → **50명 인플루언서 × 각 30 영상 = 1,500 영상** (`tiktoker_crawling_df_0121.csv`). 키워드 검색만으로 끝내지 않고 인플루언서별 *최근 30 영상* (K + non-K 섞임) 을 의도적으로 수집해 within-FE 표본 확보
- **2차 (2025-01-27)**: +6명 인플루언서 신규 추가 = **56명 × 30 영상 = 1,680 영상** (`tiktoker_final_df_0127.csv`)
